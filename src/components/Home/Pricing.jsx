...
const PricingTier = ({ title, price, features, recommended }) => {
    return (
        ...
        >
            ...
            <p className="mb-6 text-4xl font-bold">{price} <span className="text-sm font-normal">FCFA/month</span></p>
            <ul className="mb-8">
    ...
    return (
        <section id="pricing" className="py-20 bg-gray-100">
            <div className="container px-4 mx-auto">
                <h2 className="mb-12 text-4xl font-bold text-center">Choose Your Plan</h2>
